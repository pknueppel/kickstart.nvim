-- plugins.lua
--
-- For plugin management/installation
...
require('lazy').setup {
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		dependencies = {
			...
			-- Useful for getting pretty icons, but requires aNerd Font.
			{ 'nvim-tree/nvim-web-devicons', enabled = vim.g.have__font },
		},
		config = function()
			-- [[ Configure Telescope ]]
